...
#. You need to know clearly that the project is in the middle and early stage,
   ...
   Please visit the :ref:`stoken_doc` for the project progress and white-paper.
...
#. We will promptly publish project information on :ref:`stoken_website`,
   :ref:`stoken_doc`, :ref:`stoken_telegram`, etc.
...
#. In order to allow more enthusiasts to participate in community organization and work,
   ...
   Read :ref:`stoken_referral_program` for more information.
#. Stoken will list on exchanges for trading when the number of users is sufficient to ensure ecological health.
#. We welcome more people to join and build the community.
   If you have good suggestions or cooperation intentions,
   please send us an email: david@beyoubox.com.
#. Thank you for your support of Stoken, let us build a decentralized, free, open and safe Internet.


by Beyou.Network Project Team
