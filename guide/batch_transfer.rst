...
It allows you to easily transfer batches of ETH and Stoken in one transaction,
...
==============================================  =============  ===================
Address                                         Amount of ETH  Amount of Stoken
==============================================  =============  ===================
...
Approve the :ref:`batch_transfer_contract` to transfer Stokens from your wallet.

Code rules: For security reasons,
**only you** and **use your own wallet** to transfer ETH and Stokens is allowed.

According to the table data in the example at the beginning of this page.
There are `1,001.000001 x10 = 10,010.00001 Stokens` will be transferred to 10 different addresses.
That means you need to have a Stoken balance greater than this number in your wallet
and then perform the approval.

.. image:: /_static/guide/metamask_enough_stoken.gif
   :align: center
   :width: 70 %
   :alt: metamask_enough_stoken.gif

Use the Ethereum browser **etherscan.io - Write Contract**,
interact with :ref:`stoken_contract` which address is **0x460cbb9409a024a55f2b7b7f69afd0da385ce850**.
...
#. Fill the :ref:`batch_transfer_contract` address ``0xf5ed657f9441672788A4935F279956745edf461B``
   ...
   then enter the value of Stoken (with 6 decimal digits),
   for example **10010.000010 Stoken** is ``10010000010``.
...
You have successfully approval the :ref:`batch_transfer_contract` for ``10010.000010 Stoken``,
then you can call the contract to do your batch transfer.

.. image:: /_static/guide/metamask_stoken_approve.gif
   :align: center
   :width: 90 %
   :alt: metamask_stoken_approve.gif
...
Batch transfer ETH and Stokens to 10 different addresses,
**0.002 ETH** and **1,001.000001 Stoken** for each.

Make sure you have a balance of ETH greater than `0.002 x10 =` **0.02 ETH**,
and already perform a approval of **10010.000010 Stokens** in the previous step.
...
#. The last blank ``stokenValue``,
   fill it with the number of stokens to be transferred per address,
   the last six digits is decimal positions,
   so, **1001.000001 Stoken** is ``1001000001`` here.
...
There are 10 transactions of ETH, and 10 transactions of Stoken, finished at one time.
