...
Copy the address of :ref:`stoken_contract`,
it is ``0x460cbb9409a024a55f2b7b7f69afd0da385ce850``,
and use ``Add Token``.

.. image:: /_static/guide/metamask_add_stoken.gif
   :align: center
   :width: 90 %
   :alt: metamask_add_stoken.gif
